...
class Alignment:
    ...
    def global_alignment(self, match: int, mismatch: int, indel: int, s1: str, s2: str):
        ...
        gapped_s1, gapped_s2 = [], []
        self.global_output(backtrack, gapped_s1, gapped_s2, s1, s2, len(s1), len(s2))
    ...
    def global_output(self, backtrack, gapped_s1, gapped_s2, s1, s2, i, j):
        """
    ...
    def test(self):
        match, mismatch, indel = 2, 5, 1
        s1 = 'TCA'
        s2 = 'CA'
        score, gapped_s1, gapped_s2 = self.global_alignment(match, mismatch, indel, s1, s2)
